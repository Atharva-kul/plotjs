...
export function createGraphlyjs(adapter) {
    ...
    return {
        ...
        drawCartesian: (config) => {
            ...
            if(!formulaStr) {
                console.error("graphlyjs error: (201 formula string required)")
                return null
            };
            ...
            if(!formula) {
                console.error("graphlyjs error: (202 there was problem in converting formula string into actual formula)")    
                return null
            };
        ...
        drawPolar: (config) => {
            ...
            // error log 1: if formula string is missing
            if(!formulaStr) {
                console.error("graphlyjs error: (203 formula string required)")
                return null
            };
            ...
            // error log 2: if there is problem in converting string into formula
            if(!formula) {
                console.error("graphlyjs error: (204 there was problem in converting formula string into actual formula)")    
                return null
            };
        ...
        drawParametric: (config) => {
            ...
            if(!formulaXStr || !formulaYStr) {
                console.error("graphlyjs error: (205 formula string required for parametric graph)")
                return null
            };
            ...
            // error log 2: if there is problem in converting string into formula
            if(!fX || !fY) {
                console.error("graphlyjs error: (206 there was problem in converting formula string into actual formula)")    
                return null
            };
        ...
        drawComplex: (config) => {
            ...
            // error log 1: if formula string is missing
            if(!formulaStr) {
                console.error("graphlyjs error: (207 formula string required for complex graph)")
                return null
            };
            ...
            // error log 2: if there is problem in converting string into formula
            if(!formula) {
                console.error("graphlyjs error: (208 there was problem in converting formula string into actual formula)")    
                return null
            };
